function [PhaseDataAfterCon, FinalPhase ] = CoarseTuning(DataBeforePhase, a_num)
    ...
    PhaseDataAfterCon = DataBeforePhase .* exp(sqrt(-1) * deg2rad(FinalPhase(1)*0 + FinalPhase(2) * a_num  ) );
